...
class PrediksiHasilUji:
    """
    Aplikasi untuk memprediksi hasil uji kimia organik
    """
...
def main():
    """Interface command line untuk aplikasi"""
    app = PrediksiHasilUji()
    
    print("=" * 60)
    print("   APLIKASI PREDIKSI HASIL UJI ORGANIK")
    print("=" * 60)
    print()
    
    while True:
        print("\n--- MENU UTAMA ---")
        print("1. Prediksi hasil uji tunggal")
        print("2. Prediksi semua tes untuk senyawa")
        print("3. Cari senyawa")
        print("4. Lihat daftar senyawa")
        print("5. Lihat daftar pereaksi")
        print("0. Keluar")
        ...
        if pilihan == "0":
            ...
            print("\n--- Prediksi Hasil Uji Tunggal ---")
            print(f"Contoh senyawa: {', '.join(app.get_compounds()[:5])}")
            senyawa = input("Masukkan nama senyawa: ").strip()
            print(f"Contoh pereaksi: {', '.join(app.get_reagents()[:5])}")
            pereaksi = input("Masukkan nama pereaksi/tes: ").strip()
            
            hasil = app.prediksi(senyawa, pereaksi)
            
            if hasil["status"] == "success":
                print("\n" + "=" * 40)
                print(f"  HASIL PREDIKSI")
                print("=" * 40)
                print(f"  Senyawa     : {hasil['senyawa']}")
                print(f"  Rumus       : {hasil['rumus']}")
                print(f"  Gugus Fungsi: {hasil['gugus_fungsi']}")
                print("-" * 40)
                print(f"  Pereaksi   : {hasil['pereaksi']}")
                print(f"  Hasil      : {hasil['hasil']}")
                print(f"  Warna      : {hasil['warna']}")
                print(f"  Perubahan : {hasil['perubahan']}")
                print("=" * 40)
            else:
                print(f"\nError: {hasil['message']}")
                if "tersedia" in hasil:
                    print(f"Reagen yang tersedia: {hasil['tersedia']}")
            ...
            hasil = app.prediksi_semua(senyawa)
            
            if hasil["status"] == "success":
                print("\n" + "=" * 50)
                print(f"  HASIL PREDIKSI SEMUA TES")
                print("=" * 50)
                print(f"  Senyawa     : {hasil['senyawa']}")
                print(f"  Rumus       : {hasil['rumus']}")
                print(f"  Gugus Fungsi: {hasil['gugus_fungsi']}")
                ...
                for tes, data in hasil["tes"].items():
                    print(f"\n  [{tes.upper()}]")
                    print(f"    Hasil     : {data['hasil']}")
                    print(f"    Warna     : {data['warna']}")
                    print(f"    Perubahan: {data['perubahan']}")
            ...
            print("\n--- Cari Senyawa ---")
            print("Kriteria: gugus, nama")
            kriteria = input("Masukkan kriteria: ").strip()
            nilai = input("Masukkan nilai yang dicari: ").strip()
            
            hasil = app.cari_senyawa(kriteria, nilai)
            
            if hasil:
                print("\n" + "=" * 40)
                print(f"  HASIL PENCARIAN ({len(hasil)} ditemukan)")
                print("=" * 40)
                for item in hasil:
                    print(f"  • {item['senyawa']} ({item['rumus']})")
                    print(f"    Gugus: {item['gugus']}")
                print("=" * 40)
            else:
                print("\nTidak ada senyawa yang cocok.")
        
        elif pilihan == "4":
            print("\n--- Daftar Senyawa ---")
            for i, senyawa in enumerate(app.get_compounds(), 1):
                data = app.senyawa_db[senyawa]
                print(f"  {i:2}. {data['nama']:<20} - {data['rumus']:<10} [{data['gugus']}]")
        
        elif pilihan == "5":
            print("\n--- Daftar Pereaksi ---")
            for i, reagents in enumerate(app.get_reagents(), 1):
                print(f"  {i:2}. {reagents}")
